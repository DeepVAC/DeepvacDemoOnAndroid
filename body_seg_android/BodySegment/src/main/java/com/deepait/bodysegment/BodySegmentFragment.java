...
import com.deepait.bodysegment.common.component.CameraSetting;
import com.deepait.bodysegment.common.component.DrawView;
import com.deepait.bodysegment.common.fragment.BaseFragment;
import com.deepait.bodysegment.common.sufaceHolder.DemoSurfaceHolder;
...
public class BodySegmentFragment extends BaseFragment {
    ...
    private final static String TAG = BodySegmentFragment.class.getSimpleName();
    ...
    private BodySegment mBodyDetector = new BodySegment();
    ...
    ToggleButton body_switch;
    ToggleButton head_switch;
...
//                "Portrait_Seg.opt.tnnproto",
                ...
                // head
                //"ultra_fast_net_head_batch3.opt.tnnmodel",
                //"ultra_fast_net_head_batch3.opt.tnnproto"
                //"ultra_fast_net_head_batch1.opt_2.tnnmodel",
                //"ultra_fast_net_head_batch1.opt_2.tnnproto"
                "ultra_fast_net_head_256_0111.opt.tnnmodel",
                "ultra_fast_net_head_256_0111.opt.tnnproto",
                "human_detect_sim_128.opt.tnnmodel",
                "human_detect_sim_128.opt.tnnproto"
...
//    }
    ...
    private void init() {
        ...
        body_switch = (ToggleButton)$(R.id.body_switch);
        head_switch = (ToggleButton)$(R.id.head_switch);
                        ...
                        if (mIsDetectingObject && isInit && data.length>0) {
                            if(!isSkip.get()) {
                                ...
                                subHandler.post(new Runnable() {
                                    @Override
                                    public void run() {
                                        boolean isDetect = mBodyDetector.predictFromStream(previewData, previewWidth, previewHeight, mRotate, body_switch.isChecked(), head_switch.isChecked(), maskPixels);
...
//                                                    monitorResult += "fps: " + String.format("%.02f", fps);
                                                ...
                                                if (isDetect && maskBitmap!=null && (!maskBitmap.isRecycled())) {
                                                    ...
                                                    if (isAsyncImage && srcBitmap!=null && (!srcBitmap.isRecycled())) {
                                                        BodySegment.YUVtoARBG(previewData, previewWidth, previewHeight, srcPixels);
